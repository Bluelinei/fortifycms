  ...
  <div id="media-browser" class="overlay-container">
    <div style="width: 100%; background: rgba(255,255,255,0.1); padding: 20px 40px;">
      ...
      <div id="fileupload" class="upload left ten-margin-left point-cursor no-select"><p class=" vertical-middle text-center"><i class="fa fa-cloud-upload fa-lg five-margin-right"></i>Upload Evidence</p></div>
